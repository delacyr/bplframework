...
public class Bpmn2Switch<T> {
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        ...
        case Bpmn2Package.VARIABILITY_SPECIFICATION: {
            ...
            if (result == null)
                result = caseBaseElement(variabilitySpecification);
            if (result == null)
                result = defaultCase(theEObject);
            return result;
        }
        case Bpmn2Package.VR_PROCESS: {
            VrProcess vrProcess = (VrProcess) theEObject;
            T result = caseVrProcess(vrProcess);
            if (result == null)
                result = caseCallableElement(vrProcess);
            if (result == null)
                result = caseFlowElementsContainer(vrProcess);
            if (result == null)
    ...
    /**
     * Returns the result of interpreting the object as an instance of '<em>Vr Process</em>'.
     * <!-- begin-user-doc -->
     * This implementation returns null;
     * returning a non-null result will terminate the switch.
     * <!-- end-user-doc -->
     * @param object the target of the switch.
     * @return the result of interpreting the object as an instance of '<em>Vr Process</em>'.
     * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
     * @generated
     */
