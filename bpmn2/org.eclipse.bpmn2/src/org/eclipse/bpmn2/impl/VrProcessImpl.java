...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Vr Process</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getAuditing <em>Auditing</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getMonitoring <em>Monitoring</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getArtifacts <em>Artifacts</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getResources <em>Resources</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getCorrelationSubscriptions <em>Correlation Subscriptions</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getSupports <em>Supports</em>}</li>
 *   <li>{@link org.eclipse.bpmn2.impl.VrProcessImpl#getDefinitionalCollaborationRef <em>Definitional Collaboration Ref</em>}</li>
 ...
 * @generated
 */
public class VrProcessImpl extends CallableElementImpl implements VrProcess {
    /**
     ...
     * @ordered
     */
    protected EList<VrProcess> supports;
    ...
    protected EClass eStaticClass() {
        return Bpmn2Package.Literals.VR_PROCESS;
    }
    ...
    public List<LaneSet> getLaneSets() {
        if (laneSets == null) {
            laneSets = new EObjectContainmentEList<LaneSet>(LaneSet.class, this,
                    Bpmn2Package.VR_PROCESS__LANE_SETS);
        }
        return laneSets;
    }
    ...
    public List<FlowElement> getFlowElements() {
        if (flowElements == null) {
            flowElements = new EObjectContainmentEList<FlowElement>(FlowElement.class, this,
                    Bpmn2Package.VR_PROCESS__FLOW_ELEMENTS);
        }
        return flowElements;
    }
    ...
    public NotificationChain basicSetAuditing(Auditing newAuditing, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__AUDITING, oldAuditing, newAuditing);
            if (msgs == null)
                msgs = notification;
            else
        ...
        if (newAuditing != auditing) {
            ...
            if (auditing != null)
                msgs = ((InternalEObject) auditing).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Bpmn2Package.VR_PROCESS__AUDITING, null, msgs);
            if (newAuditing != null)
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__AUDITING, newAuditing, newAuditing));
    }
    ...
    public NotificationChain basicSetMonitoring(Monitoring newMonitoring, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__MONITORING, oldMonitoring, newMonitoring);
            if (msgs == null)
                msgs = notification;
            else
                msgs.add(notification);
        ...
        if (newMonitoring != monitoring) {
            ...
            if (monitoring != null)
                msgs = ((InternalEObject) monitoring).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
                        - Bpmn2Package.VR_PROCESS__MONITORING, null, msgs);
            ...
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__MONITORING, newMonitoring, newMonitoring));
    }
    ...
    public List<Property> getProperties() {
        if (properties == null) {
            properties = new EObjectContainmentEList<Property>(Property.class, this,
                    Bpmn2Package.VR_PROCESS__PROPERTIES);
        }
        return properties;
    }
    ...
    public List<Artifact> getArtifacts() {
        if (artifacts == null) {
            artifacts = new EObjectContainmentEList<Artifact>(Artifact.class, this,
                    Bpmn2Package.VR_PROCESS__ARTIFACTS);
        }
        return artifacts;
    }
    ...
    public List<ResourceRole> getResources() {
        if (resources == null) {
            resources = new EObjectContainmentEList<ResourceRole>(ResourceRole.class, this,
                    Bpmn2Package.VR_PROCESS__RESOURCES);
        }
        return resources;
    }
    ...
    public List<CorrelationSubscription> getCorrelationSubscriptions() {
        if (correlationSubscriptions == null) {
            correlationSubscriptions = new EObjectContainmentEList<CorrelationSubscription>(
                    ...
                    Bpmn2Package.VR_PROCESS__CORRELATION_SUBSCRIPTIONS);
        }
     ...
     * @generated
     */
    public List<VrProcess> getSupports() {
        if (supports == null) {
            supports = new EObjectResolvingEList<VrProcess>(VrProcess.class, this,
                    Bpmn2Package.VR_PROCESS__SUPPORTS);
        }
        return supports;
    }
            ...
            if (definitionalCollaborationRef != oldDefinitionalCollaborationRef) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            Bpmn2Package.VR_PROCESS__DEFINITIONAL_COLLABORATION_REF,
    ...
    public void setIsClosed(boolean newIsClosed) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__IS_CLOSED, oldIsClosed, isClosed));
    }
    ...
    public void setIsExecutable(boolean newIsExecutable) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__IS_EXECUTABLE, oldIsExecutable, isExecutable));
    }
    ...
    public void setProcessType(ProcessType newProcessType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.VR_PROCESS__PROCESS_TYPE, oldProcessType, processType));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID,
        ...
        switch (featureID) {
        case Bpmn2Package.VR_PROCESS__LANE_SETS:
            return ((InternalEList<?>) getLaneSets()).basicRemove(otherEnd, msgs);
        case Bpmn2Package.VR_PROCESS__FLOW_ELEMENTS:
            return ((InternalEList<?>) getFlowElements()).basicRemove(otherEnd, msgs);
        case Bpmn2Package.VR_PROCESS__AUDITING:
            return basicSetAuditing(null, msgs);
        case Bpmn2Package.VR_PROCESS__MONITORING:
            return basicSetMonitoring(null, msgs);
        case Bpmn2Package.VR_PROCESS__PROPERTIES:
            return ((InternalEList<?>) getProperties()).basicRemove(otherEnd, msgs);
        case Bpmn2Package.VR_PROCESS__ARTIFACTS:
            return ((InternalEList<?>) getArtifacts()).basicRemove(otherEnd, msgs);
        case Bpmn2Package.VR_PROCESS__RESOURCES:
            return ((InternalEList<?>) getResources()).basicRemove(otherEnd, msgs);
        case Bpmn2Package.VR_PROCESS__CORRELATION_SUBSCRIPTIONS:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case Bpmn2Package.VR_PROCESS__SUPPORTS:
            return getSupports();
        case Bpmn2Package.VR_PROCESS__DEFINITIONAL_COLLABORATION_REF:
            if (resolve)
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case Bpmn2Package.VR_PROCESS__SUPPORTS:
            getSupports().clear();
            getSupports().addAll((Collection<? extends VrProcess>) newValue);
            return;
        case Bpmn2Package.VR_PROCESS__DEFINITIONAL_COLLABORATION_REF:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == FlowElementsContainer.class) {
            ...
            case Bpmn2Package.FLOW_ELEMENTS_CONTAINER__LANE_SETS:
                return Bpmn2Package.VR_PROCESS__LANE_SETS;
            case Bpmn2Package.FLOW_ELEMENTS_CONTAINER__FLOW_ELEMENTS:
                return Bpmn2Package.VR_PROCESS__FLOW_ELEMENTS;
            default:
                return -1;
            }
        }
