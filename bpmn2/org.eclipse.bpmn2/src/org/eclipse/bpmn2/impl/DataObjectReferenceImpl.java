 ...
 *   <li>{@link org.eclipse.bpmn2.impl.DataObjectReferenceImpl#getFeatureType <em>Feature Type</em>}</li>
...
public class DataObjectReferenceImpl extends FlowElementImpl implements DataObjectReference {
    ...
    public void setFeatureType(String newFeatureType) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    Bpmn2Package.DATA_OBJECT_REFERENCE__FEATURE_TYPE, oldFeatureType, featureType));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        ...
        case Bpmn2Package.DATA_OBJECT_REFERENCE__VARIANT:
            return isVariant();
        case Bpmn2Package.DATA_OBJECT_REFERENCE__FEATURE_TYPE:
    ...
    public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
        if (baseClass == ItemAwareElement.class) {
            ...
            case Bpmn2Package.ITEM_AWARE_ELEMENT__FEATURE_TYPE:
                return Bpmn2Package.DATA_OBJECT_REFERENCE__FEATURE_TYPE;
