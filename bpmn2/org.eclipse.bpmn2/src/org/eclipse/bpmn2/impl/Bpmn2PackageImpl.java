...
public class Bpmn2PackageImpl extends EPackageImpl implements Bpmn2Package {
     ...
     * @generated
     */
    private EClass vrProcessEClass = null;
     ...
     * @generated
     */
    public EReference getDocumentRoot_VrSpecification() {
     ...
     * @generated
     */
    public EReference getDocumentRoot_VrProcess() {
     ...
     * @generated
     */
    public EReference getActivity_VrSpecification() {
     ...
     * @generated
     */
    public EAttribute getActivity_VarPoint() {
     ...
     * @generated
     */
    public EAttribute getActivity_VarPointType() {
        return (EAttribute) getActivity().getEStructuralFeatures().get(13);
    }
     ...
     * @generated
     */
    public EAttribute getActivity_Variant() {
        return (EAttribute) getActivity().getEStructuralFeatures().get(14);
    }
     ...
     * @generated
     */
    public EAttribute getActivity_Solved() {
     ...
     * @generated
     */
    public EAttribute getActivity_InstanceName() {
     ...
     * @generated
     */
    public EAttribute getActivity_SpecsName() {
     ...
     * @generated
     */
    public EAttribute getDataAssociation_Name() {
        return (EAttribute) getDataAssociation().getEStructuralFeatures().get(4);
    }
     ...
     * @generated
     */
    public EReference getItemAwareElement_VrSpecification() {
     ...
     * @generated
     */
    public EAttribute getItemAwareElement_VarPoint() {
        return (EAttribute) getItemAwareElement().getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EAttribute getItemAwareElement_VarPointType() {
        return (EAttribute) getItemAwareElement().getEStructuralFeatures().get(4);
    }
     ...
     * @generated
     */
    public EAttribute getItemAwareElement_Variant() {
        return (EAttribute) getItemAwareElement().getEStructuralFeatures().get(5);
    }
    ...
    public EClass getVariabilitySpecification() {
        if (variabilitySpecificationEClass == null) {
            variabilitySpecificationEClass = (EClass) EPackage.Registry.INSTANCE
     ...
     * @generated
     */
    public EClass getVrProcess() {
        if (vrProcessEClass == null) {
            vrProcessEClass = (EClass) EPackage.Registry.INSTANCE.getEPackage(Bpmn2Package.eNS_URI)
                    .getEClassifiers().get(148);
        }
        return vrProcessEClass;
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Auditing() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(0);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Monitoring() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(1);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Properties() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(2);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Artifacts() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(3);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Resources() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(4);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_CorrelationSubscriptions() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(5);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_Supports() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(6);
    }
     ...
     * @generated
     */
    public EReference getVrProcess_DefinitionalCollaborationRef() {
        return (EReference) getVrProcess().getEStructuralFeatures().get(7);
    }
     ...
     * @generated
     */
    public EAttribute getVrProcess_IsClosed() {
        return (EAttribute) getVrProcess().getEStructuralFeatures().get(8);
    }
     ...
     * @generated
     */
    public EAttribute getVrProcess_IsExecutable() {
        return (EAttribute) getVrProcess().getEStructuralFeatures().get(9);
    }
     ...
     * @generated
     */
    public EAttribute getVrProcess_ProcessType() {
        return (EAttribute) getVrProcess().getEStructuralFeatures().get(10);
    }
