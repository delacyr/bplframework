...
public class DataAssociationItemProvider extends BaseElementItemProvider implements
    ...
    protected void addNamePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_DataAssociation_name_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_DataAssociation_name_feature",
                        "_UI_DataAssociation_type"), Bpmn2Package.Literals.DATA_ASSOCIATION__NAME,
    ...
    public void notifyChanged(Notification notification) {
        ...
        case Bpmn2Package.DATA_ASSOCIATION__NAME:
