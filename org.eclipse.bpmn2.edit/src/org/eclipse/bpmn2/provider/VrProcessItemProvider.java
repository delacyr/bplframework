...
/**
 * This is the item provider adapter for a {@link org.eclipse.bpmn2.VrProcess} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VrProcessItemProvider extends CallableElementItemProvider implements
     ...
     * @generated
     */
    public VrProcessItemProvider(AdapterFactory adapterFactory) {
    ...
    protected void addSupportsPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ...
                getResourceLocator(),
                getString("_UI_VrProcess_supports_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_VrProcess_supports_feature",
                        "_UI_VrProcess_type"), Bpmn2Package.Literals.VR_PROCESS__SUPPORTS, true,
    ...
    protected void addDefinitionalCollaborationRefPropertyDescriptor(Object object) {
        itemPropertyDescriptors
                .add(createItemPropertyDescriptor(
                        ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                        getResourceLocator(),
                        getString("_UI_VrProcess_definitionalCollaborationRef_feature"),
                        getString("_UI_PropertyDescriptor_description",
                                "_UI_VrProcess_definitionalCollaborationRef_feature",
                                "_UI_VrProcess_type"),
                        Bpmn2Package.Literals.VR_PROCESS__DEFINITIONAL_COLLABORATION_REF, true,
                        false, true, null, null, null));
    }
    ...
    protected void addIsClosedPropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_VrProcess_isClosed_feature"),
                getString("_UI_PropertyDescriptor_description", "_UI_VrProcess_isClosed_feature",
                        "_UI_VrProcess_type"), Bpmn2Package.Literals.VR_PROCESS__IS_CLOSED, true,
    ...
    protected void addIsExecutablePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_VrProcess_isExecutable_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_VrProcess_isExecutable_feature", "_UI_VrProcess_type"),
                Bpmn2Package.Literals.VR_PROCESS__IS_EXECUTABLE, true, false, false,
    ...
    protected void addProcessTypePropertyDescriptor(Object object) {
        itemPropertyDescriptors.add(createItemPropertyDescriptor(
                ((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
                getResourceLocator(),
                getString("_UI_VrProcess_processType_feature"),
                getString("_UI_PropertyDescriptor_description",
                        "_UI_VrProcess_processType_feature", "_UI_VrProcess_type"),
                Bpmn2Package.Literals.VR_PROCESS__PROCESS_TYPE, true, false, false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(Bpmn2Package.Literals.VR_PROCESS__AUDITING);
            childrenFeatures.add(Bpmn2Package.Literals.VR_PROCESS__MONITORING);
            childrenFeatures.add(Bpmn2Package.Literals.VR_PROCESS__PROPERTIES);
            childrenFeatures.add(Bpmn2Package.Literals.VR_PROCESS__CORRELATION_SUBSCRIPTIONS);
        }
    ...
    public Object getImage(Object object) {
        try {
            return overlayImage(object, getResourceLocator().getImage("full/obj16/VrProcess.png"));
        } catch (java.util.MissingResourceException e) {
            return overlayImage(object, getResourceLocator().getImage("full/obj16/VrProcess.gif"));
        }
    }
    ...
    public String getText(Object object) {
        String label = ((VrProcess) object).getName();
        return label == null || label.length() == 0 ? getString("_UI_VrProcess_type")
                : getString("_UI_VrProcess_type") + " " + label;
    }
    ...
    public void notifyChanged(Notification notification) {
        ...
        switch (notification.getFeatureID(VrProcess.class)) {
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.VR_PROCESS__AUDITING,
                Bpmn2Factory.eINSTANCE.createAuditing()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.VR_PROCESS__MONITORING,
                Bpmn2Factory.eINSTANCE.createMonitoring()));

        newChildDescriptors.add(createChildParameter(Bpmn2Package.Literals.VR_PROCESS__PROPERTIES,
                Bpmn2Factory.eINSTANCE.createProperty()));

        newChildDescriptors.add(createChildParameter(
                Bpmn2Package.Literals.VR_PROCESS__CORRELATION_SUBSCRIPTIONS,
