...
public class SequenceObjectEditor extends ComboObjectEditor {
...
//	public static String NONE_VALUE = "##NONE"; //$NON-NLS-1$
	...
	public SequenceObjectEditor(AbstractDetailComposite parent, EObject object, EStructuralFeature feature) {
...
//		SequenceEditingDialog dialog = new SequenceEditingDialog(
//				getDiagramEditor().getEditorSite().getShell(), 
...
//	public class SequenceEditingDialog extends InputDialog {
//		public SequenceEditingDialog(Shell shell, String title, final Map<String,Object> choices, final String uriString) {
//			super(
//					shell,
//					title,
