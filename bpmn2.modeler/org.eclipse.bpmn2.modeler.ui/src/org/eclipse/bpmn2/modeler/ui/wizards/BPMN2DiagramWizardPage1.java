...
//BPMN*code
		...
		Label vrprocessLabel = new Label(container, SWT.WRAP | SWT.NONE);
		data = new GridData(SWT.LEFT,SWT.FILL,false,false,1,1);
		data.widthHint = labelWidth;
		vrprocessLabel.setLayoutData(data);
		vrprocessLabel.setText(Messages.BPMN2DiagramWizardPage1_VrProcess_Diagram_Description);
