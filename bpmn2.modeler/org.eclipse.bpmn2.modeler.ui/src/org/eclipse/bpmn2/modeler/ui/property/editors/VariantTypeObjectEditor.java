...
public class VariantTypeObjectEditor extends ComboObjectEditor {

	public static String DEFAULT_LABEL = Messages.VariantTypeObjectEditor_Default_Label;
	public static String DEFAULT_VALUE = "##default"; //$NON-NLS-1$	
	public static String VARIABLE_LABEL = Messages.VariantTypeObjectEditor_Variable_Label;
	public static String VARIABLE_VALUE = "##variable"; //$NON-NLS-1$
	public static String VARIANT_LABEL = Messages.VariantTypeObjectEditor_Variant_Label;
	public static String VARIANT_VALUE = "##variant"; //$NON-NLS-1$

	
	public VariantTypeObjectEditor(AbstractDetailComposite parent, EObject object, EStructuralFeature feature) {
	...
	public Object getValue() {
		...
		else if (VARIABLE_VALUE.equals(value)) {
			value = VARIABLE_LABEL;
		}
		else if (VARIANT_VALUE.equals(value)) {
			value = VARIANT_LABEL;
		}
		if (value == null)
			value = "";
				...
				if (definitions!=null) {
					...
					domain.getCommandStack().execute(new RecordingCommand(domain) {
						...
						protected void doExecute() {
							...
							while (iter.hasNext()) {
								EObject o = iter.next();
								EStructuralFeature f = o.eClass().getEStructuralFeature("variantType"); //$NON-NLS-1$
								if (f!=null) {
	...
	protected Hashtable<String,Object> getChoiceOfValues(EObject object, EStructuralFeature feature) {
		...
		choices.put(DEFAULT_LABEL, ModelUtil.createStringWrapper(DEFAULT_VALUE));
		choices.put(VARIABLE_LABEL, ModelUtil.createStringWrapper(VARIABLE_VALUE));
		choices.put(VARIANT_LABEL, ModelUtil.createStringWrapper(VARIANT_VALUE));
